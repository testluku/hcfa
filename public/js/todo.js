...
var todo = todo || {},
    data = $.ajax({
		url: "http://localhost/hcfa/public/tasks/tareas",
	    dataType: 'json',
	    type: 'GET',
	    delay: 250,
...
(function(todo, data, $) {
    ...
    todo.init = function (options) {
            ...
            $(value).droppable({
                drop: function (event, ui) {
                        var element = ui.helper,
                            ...
                            id = $.ajax({
                        		url: "http://localhost/hcfa/public/tasks/idupdatetask",
                        	    dataType: 'json',
                        	    type: 'GET',
                        	    delay: 250,
                        	    data: {
        ...
        $("#" + options.deleteDiv).droppable({
            drop: function(event, ui) {
                ...
                id = $.ajax({
            		url: "http://localhost/hcfa/public/tasks/iddeletetask",
            	    dataType: 'json',
            	    type: 'GET',
            	    delay: 250,
            	    data: {
    ...
    todo.add = function() {
        ...
        id = $.ajax({
    		url: "http://localhost/hcfa/public/tasks/idsavetask",
    	    dataType: 'json',
    	    type: 'GET',
    	    delay: 250,
    	    data: {
