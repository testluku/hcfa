    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , urlstrict:  "Debe ser una url válida."
          , number:     "Debe ser un número válido."
          , digits:     "Deben ser digitos."
          , dateIso:    "El formato de la fecha debe ser (AAAA-MM-DD)."
      ...
      , regexp:         "Este campo contiene caracteres invalidos."
      , min:            "Debe ser un valor mayor o igual a %s."
      , max:            "Debe ser un valor menor o igual a %s."
      , range:          "Debe ser un valor entre %s y %s."
      , minlength:      "Faltan caracteres. Debe tener al menos %s caracteres o más."
      , maxlength:      "Excedió el número de caracteres. Deber tener %s caracteres o menos."
      , rangelength:    "El tamaño del valor es invalido. Debe estar entre %s y %s caracteres."
