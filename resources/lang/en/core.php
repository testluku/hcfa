...
// General 
	...
	"notepassword" => "Deje el espacio vacío si no desea cambiar la actual contraseña", // updated apidevlab	
	"submit" => "Enviar",
	...
	"registernew" => "Registrar Cuenta Nueva",
	"backtosite" => " Volver al Sitio ",
	
/* grid , pagination */
	"grid_displaying" 	=> "Mostrar",
	"grid_to" 			=> "a",
	"grid_of" 			=> "de",
	"grid_show" 			=> "Mostrar",
...
/* Menu navigation here */
	...
	"m_dashboard" 		=> "Principal",
	"m_setting" 		=> "Ajustes", // updated apidevlab
	"m_usersgroups" 	=> "Usuarios & Grupos",
	"m_users" 			=> "Usuarios",
	"m_groups" 			=> "Grupos",
	"m_pagecms" 		=> "Página CMS",
	"m_menu" 			=> "Gestionar Menú",
	"m_logs" 			=> "Logs de Actividad",
	"m_codebuilder" 	=> "Compilar Código",
	"m_blastemail" 		=> "Correo Másivo",
...
/* Setting page translation */	
	...
	"t_generalsetting"		=> "Ajustes Generales", //updated apidevlab
