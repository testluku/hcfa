...
<div class="sbox">
	<div class="sbox-title"> 
		...
		<div class="sbox-tools" >
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Limpiar Búsqueda" onclick="reloadData('#{{ $pageModule }}','{class}/data?search=')"><i class="fa fa-trash-o"></i> Limpiar Búsqueda </a>
			<a href="javascript:void(0)" class="btn btn-xs btn-white tips" title="Recargar Información" onclick="reloadData('#{{ $pageModule }}','{class}/data?return={{ $return }}')"><i class="fa fa-refresh"></i></a>
