...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			...
			@endif 
			<a href="{{ URL::to( '{class}/search/native') }}" class="btn btn-sm btn-white" onclick="SximoModal(this.href,'Búsqueda Avanzada'); return false;" ><i class="fa fa-search"></i> Buscar</a>				
