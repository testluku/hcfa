...
El día de hoy se registró una solicitud al sistema de autorizaciones del instituto del corazón.
<br><br>
</div>
...
$rad=explode(',', $radicado);
?>
<div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
  <ol>
  	<?php 
  	for($i=0;$i<sizeof($serv)-1;$i++)
  	{
  		echo '<li>'.$serv[$i].'<br> Radicado:'.$rad[$i].'</li>';
  	}
  	
  	?>
  </ol>
<div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
Usted recibirá después de {{ $fechaEsperada }} nuevamente un correo informándole el número de autorización y si debe o no acercarse al instituto del corazón nuevamente.
<br><br> 
