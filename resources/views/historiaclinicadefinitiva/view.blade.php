...
<div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('historiaclinicadefinitiva?return='.$return) }}">{{ $pageTitle }}</a></li>
 	...
 	<div class="page-content-wrapper">   
	   <div class="toolbar-line">
	   		<a href="{{ URL::to('historiaclinicadefinitiva?return='.$return) }}" class="tips btn btn-xs btn-default" title="{{ Lang::get('core.btn_back') }}"><i class="fa fa-arrow-circle-left"></i>&nbsp;{{ Lang::get('core.btn_back') }}</a>
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('historiaclinicadefinitiva/update/'.$id.'?return='.$return) }}" class="tips btn btn-xs btn-primary" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit"></i>&nbsp;{{ Lang::get('core.btn_edit') }}</a>
			@endif  		   	  
		</div>
		...
		<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('IdHistoriaClinica', (isset($fields['idHistoriaClinica']['language'])? $fields['idHistoriaClinica']['language'] : array())) }}	
						</td>
						<td>{{ $row->idHistoriaClinica }} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('AsimetriaFosasNasales Copy1', (isset($fields['asimetriaFosasNasales_copy1']['language'])? $fields['asimetriaFosasNasales_copy1']['language'] : array())) }}	
						</td>
						<td>{{ $row->asimetriaFosasNasales_copy1 }} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('DocumentoListaChequeo', (isset($fields['documentoListaChequeo']['language'])? $fields['documentoListaChequeo']['language'] : array())) }}	
						</td>
						<td>{{ $row->documentoListaChequeo }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('DocumentoContrato', (isset($fields['documentoContrato']['language'])? $fields['documentoContrato']['language'] : array())) }}	
						</td>
						<td>{{ $row->documentoContrato }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('DocumentoConsentimientos', (isset($fields['documentoConsentimientos']['language'])? $fields['documentoConsentimientos']['language'] : array())) }}	
						</td>
						<td>{{ $row->documentoConsentimientos }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('DocumentoInformacionComplicaciones', (isset($fields['documentoInformacionComplicaciones']['language'])? $fields['documentoInformacionComplicaciones']['language'] : array())) }}	
						</td>
						<td>{{ $row->documentoInformacionComplicaciones }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>
							{{ SiteHelpers::activeLang('DocumentoDescripcionesQuirurgicas', (isset($fields['documentoDescripcionesQuirurgicas']['language'])? $fields['documentoDescripcionesQuirurgicas']['language'] : array())) }}	
						</td>
						<td>{{ $row->documentoDescripcionesQuirurgicas }} </td>
