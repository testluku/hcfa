...
<div class="page-content row">
	<div class="page-header">
	  <div class="page-title">
		<h3><i class="fa fa-desktop"></i> Tablero <small> Resumen información del sitio </small></h3>
	  </div>
...
<section>
	...
	<div class="row m-t">
		<div class="col-md-12">
			<div class="sbox">
				<div class="sbox-title"> <h3> Usuarios Recientes <small> ( Última Actividad ) </small> </h3> </div>
