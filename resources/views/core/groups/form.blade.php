...
<div class="col-md-12">
						<fieldset><legend> Grupos de Usuarios</legend>
									
								  <div class="form-group hidethis " style="display:none;">
									<label for="Group Id" class=" control-label col-md-4 text-left"> Id Grupo </label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Name" class=" control-label col-md-4 text-left"> Nombre <span class="asterix"> * </span></label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Description" class=" control-label col-md-4 text-left"> Descripción </label>
									<div class="col-md-6">
				           ...
				           >{{ $row['description'] }}</textarea> 
								  ...
								  <div class="form-group  " >
									<label for="Level" class=" control-label col-md-4 text-left"> Nivel <span class="asterix"> * </span></label>
									<div class="col-md-6">
