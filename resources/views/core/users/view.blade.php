...
<div class="sbox animated fadeInRight">
	...
	<table class="table table-striped table-bordered" >
		<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>Nombre(s)</td>
						<td>{{ $row->first_name }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Apellido(s)</td>
						<td>{{ $row->last_name }} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Creado el</td>
						<td>{{ $row->created_at }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Último Inicio de Sesión</td>
						<td>{{ $row->last_login }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Actualizado el</td>
