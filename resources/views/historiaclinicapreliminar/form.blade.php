    ...
    <div class="form-group" style="">
      <div class="col-xs-3" style="margin-top: 20px;">
          <ul class="nav nav-tabs tabs-left" style="padding-left: 0;">
            ...
            <li><a href="#examenfisico" data-toggle="tab">Examen F&iacute;sico</a></li>
...
@if(!$idhc)
<div class="sendhc">
  <button type="submit" class="btn btn-success" name="button">Guardar historia clinica preliminar.</button>
</div>
@else
<div class="sendhc">
