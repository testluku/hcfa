  ...
  <!-- Begin Header & Breadcrumb -->
	...
	<div class="page-content-wrapper m-t">
      ...
      <div class="col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2">
          {!! Form::open(array('url'=>'cotizacion/updated?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <!-- Invoice Block -->
          <div class="block">
              <!-- Invoice Title -->
            ...
            -->
              ...
              <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr class="d contField">
                            ...
                            <td>
                              <div class="input_container">
                                ...
                                {!! Form::text('', '', array('id' => 'productoId', 'class'=>'productClass', 'placeholder'=>'', 'name'=> 'item[1][productoservicio]', 'autocomplete' => 'off' )) !!}
                                <ul id="product_list_id" class="product_list_class"></ul>
                              </div>
                            </td>
                            <td class="text-right quantity-box"><span class="label label-success"><strong>x {!! Form::number('', '' ,array('class'=>'quantity', 'placeholder'=>'', 'name'=> 'item[1][quantity]'  )) !!}</strong></span></td>
                            <td class="text-right">$ {!! Form::number('', '', array('class'=>'unit', 'placeholder'=>'', 'name'=> 'item[1][unit]' )) !!}</td>
                            <td class="text-right">$ {!! Form::number('', '', array('class'=>'descuento', 'placeholder'=>'', 'name'=> 'item[1][descuento]', 'autocomplete' => 'off', 'required', 'min'=>'0'  )) !!}</td>
                            <td class="text-right amount">$ </td>


                              {!! Form::hidden('idCotizacion', $idCotizacion, array('id' => '')) !!}
                        </tr>
                        ...
                        @endif
                              ...
                              <tr class="totalfinal">
                                  ...
                                  <td class="text-right"><span class="h4">$</span><span class="h4"><strong class="total_final">{{ number_format($row_account->subtotal - $row_account->descuento_total,0,'.','.')}}</strong></span></td>
                              </tr>
                      </tbody>
                  </table>
                  ...
                  <button type="button" onclick="location.href='{{ URL::to('paciente/') }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i> Cancelar </button>
                  </div>
                  </div>
              </div>
              <div class="buttons">
