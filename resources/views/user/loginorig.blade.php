...
<div class="sbox ">
	<div class="sbox-title">
				<h3 >{{ CNF_APPNAME }} <br/><small> {{ CNF_APPDESC }} </small></h3>
	</div>
	<div class="sbox-content">
	<div class="text-center animated fadeInDown delayp1 color-fondo" style="background-color: #5ccdde;">
		<img src="{{ asset('sximo/images/logoic.png')}}"  height="40" />
	</div>	
	...
	<div class="tab-content" >
		...
		<form method="post" action="{{ url('user/signin')}}" class="form-vertical">
			...
			<div class="form-group has-feedback animated fadeInLeft delayp1">
				...
				<input type="text" name="email" placeholder="Correo Electrónico" class="form-control" required="email" />
