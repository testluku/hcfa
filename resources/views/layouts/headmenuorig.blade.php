<div class="row  ">
         ...
         <li>   
            ...
            >
                ...
                <ul class="dropdown-menu dropdown-alerts notif-value" code="{{ url()}}">
                	<li><div class="text-center link-block"><a href="{{ url('notification') }}"><strong>Ver todas las notificaciones</strong> <i class="fa fa-angle-right"></i></a></div></li>
		...
		<li class="user dropdown"><a class="dropdown-toggle" href="javascript:void(0)"  data-toggle="dropdown"><i class="fa fa-user"></i> <span>{{ Lang::get('core.m_myaccount') }}</span><i class="caret"></i></a>
		  <ul class="dropdown-menu dropdown-menu-right icons-right">
			...
			<li><a href="{{ URL::to('')}}" target="_blank"><i class="fa fa-desktop"></i>  Sitio Público </a></li>
			<li><a href="{{ URL::to('user/profile')}}"><i class="fa fa-user"></i> {{ Lang::get('core.m_profile') }}</a></li>
			<li><a href="{{ URL::to('core/elfinder')}}"><i class="fa fa-folder"></i>  Administrar Archivos </a></li>
